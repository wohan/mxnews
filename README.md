...
- **Счётчик посещений** с аналитикой
...
│   ├── counter.php           # API счётчика
│   └── index.php             # Панель статистики
...
Сайт включает встроенный счётчик посещений:

- **Клиентская часть:** JavaScript в `js/main.js`
- **Серверная часть:** PHP в `stats/counter.php`
- **Панель статистики:** `https://newsmx.ru/stats/`
